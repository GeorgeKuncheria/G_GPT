...
G_GPT is an open-source **agentic AI chatbot** built with **Python, FastAPI, LangGraph, LangChain, Google Gemini, Tavily, ChromaDB, and SQLite**.
...
```bash
git clone https://github.com/entG_/G_GPT.git
```
...
```bash
conda create -n G_gpt python=3.11 -y
```

### 4. Activate the virtual environment

```bash
conda activate G_gpt
```
...
```text
315865595366.dkr.ecr.us-east-1.amazonaws.com/G_gpt
```
